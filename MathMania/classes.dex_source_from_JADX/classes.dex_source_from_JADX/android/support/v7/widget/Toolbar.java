...
public class Toolbar extends ViewGroup {
    ...
    class C02451 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02451() {
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C02451();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
