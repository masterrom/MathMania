...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01724 implements OnFocusChangeListener {
        C01724() {
        }
    ...
    class C01735 implements OnLayoutChangeListener {
        C01735() {
        }
    ...
    class C01746 implements OnGlobalLayoutListener {
        C01746() {
        }
    ...
    class C01757 implements OnClickListener {
        C01757() {
        }
    ...
    class C01768 implements OnKeyListener {
        C01768() {
        }
    ...
    class C01779 implements OnEditorActionListener {
        C01779() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02441());
        boolean isIconified;

        static class C02441 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02441() {
            }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01691();
        this.mUpdateDrawableStateRunnable = new C01702();
        this.mReleaseCursorRunnable = new C01713();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01757();
        this.mTextKeyListener = new C01768();
        this.mOnEditorActionListener = new C01779();
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0146R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0146R.styleable.SearchView_submitBackground));
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01724());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01735());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01746());
    }
