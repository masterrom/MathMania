...
public class PopupMenu {
    ...
    class C01672 implements android.widget.PopupWindow.OnDismissListener {
        C01672() {
        }
    ...
    class C02421 implements Callback {
        C02421() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C02421());
        ...
        this.mPopup.setOnDismissListener(new C01672());
    }
