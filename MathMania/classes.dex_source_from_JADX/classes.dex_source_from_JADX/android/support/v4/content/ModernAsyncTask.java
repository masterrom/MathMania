...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00371();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01942();

    static class C00371 implements ThreadFactory {
    ...
    class C01942 extends WorkerRunnable<Params, Result> {
        C01942() {
        }
