...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01031();
    ...
    private static final Interpolator sInterpolator = new C01042();
    ...
    private final Runnable mEndScrollRunnable = new C01053();
    ...
    static class C01031 implements Comparator<ItemInfo> {
        C01031() {
        }
    ...
    static class C01042 implements Interpolator {
        C01042() {
        }
    ...
    class C02174 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02181());
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02174());
    }
