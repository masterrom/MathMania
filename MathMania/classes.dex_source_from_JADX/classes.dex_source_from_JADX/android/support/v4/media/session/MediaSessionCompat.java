...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C00811();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C00811 implements Creator<QueueItem> {
            C00811() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C00821();
        private ResultReceiver mResultReceiver;

        static class C00821 implements Creator<ResultReceiverWrapper> {
            C00821() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C00831();
        private final Object mInner;

        static class C00831 implements Creator<Token> {
            C00831() {
            }
    ...
    class C02041 extends Callback {
        C02041() {
        }
    }

    class C02052 extends Callback {
        C02052() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02061();
        ...
        class C02061 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02061() {
            }
        ...
        class C02472 implements Callback {
            C02472() {
            }
